...
class WeaponController extends Controller
{
    ...
    {
        $listWeapons = $this->getDoctrine()->getManager()->getRepository('DnDRulesWeaponBundle:Weapon')->findAll();
    ...
    public function registerAction()
    {
        ...
        return $this->render('DnDRulesWeaponBundle:Weapon:Register/register.html.twig', array(
