 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DnDRules\MonsterBundle\Entity\MonsterTypeInstanceRepository")
 */
class MonsterTypeInstance
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="DnDRules\MonsterBundle\Entity\MonsterType")
     * @ORM\JoinColumn(nullable=false)
     */
    private $monsterType;

    /**
     * @ORM\ManyToOne(targetEntity="DnDRules\MonsterBundle\Entity\MonsterSubType")
     * @ORM\JoinColumn(nullable=false)
     */
