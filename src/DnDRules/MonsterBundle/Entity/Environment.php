 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DnDRules\MonsterBundle\Entity\EnvironmentRepository")
 * 
 * @UniqueEntity(fields="name", message="Un environnement semble déjà porter ce nom ...")
 */
class Environment
{
    /**
