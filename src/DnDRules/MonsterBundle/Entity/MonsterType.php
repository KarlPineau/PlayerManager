 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DnDRules\MonsterBundle\Entity\MonsterTypeRepository")
 * 
 * @UniqueEntity(fields="name", message="Une typologie de monstres semble déjà porter ce nom ...")
 */
class MonsterType
{
    /**
