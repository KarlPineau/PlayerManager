 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DnDRules\SortBundle\Entity\SortSchoolRepository")
 * 
...
class SortSchool
{
     ...
     * )
     * @ORM\Column(name="plugged", type="string", length=255, nullable=true)
     */
    private $plugged;
    ...
    */
     ...
     * @return SortSchool
     */
    public function setPlugged($plugged)
    {
