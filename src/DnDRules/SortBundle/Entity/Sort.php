 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DnDRules\SortBundle\Entity\SortRepository")
 * 
...
class Sort
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="DnDRules\SortBundle\Entity\SortClassDnD", mappedBy="sort", cascade={"persist", "remove"})
     */
    private $classes;
    
    /**
     * @ORM\OneToMany(targetEntity="DnDRules\SortBundle\Entity\SortDomain", mappedBy="sort", cascade={"persist", "remove"})
     */
    private $domains;

    /**
     * @ORM\ManyToMany(targetEntity="DnDRules\SortBundle\Entity\Composante", cascade={"persist"})
     * @ORM\JoinColumn(nullable=true)
    */
    protected $composantes;
    
    /**
     * @ORM\ManyToOne(targetEntity="DnDRules\SortBundle\Entity\SortSchool")
     * @ORM\JoinColumn(nullable=true)
    */
    ...
    */
     ...
     * Add classes
     *
     * @param \DnDRules\SortBundle\Entity\SortClassDnD $classes
     * @return Sort
     */
    public function addClass(\DnDRules\SortBundle\Entity\SortClassDnD $classes)
    {
     ...
     * @param \DnDRules\SortBundle\Entity\SortClassDnD $classes
     */
    public function removeClass(\DnDRules\SortBundle\Entity\SortClassDnD $classes)
    {
     ...
     * Add domains
     *
     * @param \DnDRules\SortBundle\Entity\SortDomain $domains
     * @return Sort
     */
    public function addDomain(\DnDRules\SortBundle\Entity\SortDomain $domains)
    {
     ...
     * @param \DnDRules\SortBundle\Entity\SortDomain $domains
     */
    public function removeDomain(\DnDRules\SortBundle\Entity\SortDomain $domains)
    {
     ...
     * Add composantes
     *
     * @param \DnDRules\SortBundle\Entity\Composante $composantes
     * @return Sort
     */
    public function addComposante(\DnDRules\SortBundle\Entity\Composante $composantes)
    {
     ...
     * @param \DnDRules\SortBundle\Entity\Composante $composantes
     */
    public function removeComposante(\DnDRules\SortBundle\Entity\Composante $composantes)
    {
     ...
     * Set sortSchool
     *
     * @param \DnDRules\SortBundle\Entity\SortSchool $sortSchool
     * @return Sort
     */
    public function setSortSchool(\DnDRules\SortBundle\Entity\SortSchool $sortSchool = null)
    {
     ...
     * Get sortSchool
     *
     * @return \DnDRules\SortBundle\Entity\SortSchool 
     */
