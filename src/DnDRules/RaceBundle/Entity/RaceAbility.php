 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DnDRules\RaceBundle\Entity\RaceAbilityRepository")
 */
class RaceAbility
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="DnDRules\RaceBundle\Entity\Race", inversedBy="abilities")
