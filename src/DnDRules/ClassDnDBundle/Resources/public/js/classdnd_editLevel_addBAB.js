function addBABPrototype(container, indexBAB) {
    if(indexBAB === 0)
    {
        var containerOrigin = container.attr('data-prototype').replace(/_classBABs_\d+/g, '_classBABs___name__');
        container.attr('data-prototype', containerOrigin);
    } 
    container.append(container.attr('data-prototype').replace(/__name__/g, indexBAB));
}

function addBAB(containerBAB, indexBAB, index) {
    addBABPrototype(containerBAB, indexBAB);
