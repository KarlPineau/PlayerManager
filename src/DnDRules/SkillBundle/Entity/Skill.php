...
namespace DnDRules\SkillBundle\Entity;
 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DnDRules\SkillBundle\Entity\SkillRepository")
 * 
 * @UniqueEntity(fields="name", message="Une compétence semble déjà porter ce nom ...")
 */
class Skill
{
    /**
